(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define('simditor-markdown', ["jquery","simple-module","simditor"], function ($, SimpleModule, Simditor) {
      return (root['SimditorMarkdown'] = factory($, SimpleModule, Simditor));
    });
    ...
    root['SimditorMarkdown'] = factory(jQuery,SimpleModule,Simditor);
  }
...
SimditorMarkdown = (function(superClass) {
  ...
  SimditorMarkdown.pluginName = 'Markdown';
